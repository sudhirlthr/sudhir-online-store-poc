...
goog.exportSymbol('proto.EmptyBlog', null, global);
...
/**
 * optional int64 blogid = 3;
 * @return {number}
 */
proto.User.prototype.getBlogid = function() {
  return /** @type {number} */ (jspb.Message.getFieldProto3(this, 3, 0));
};


/** @param {number} value  */
proto.User.prototype.setBlogid = function(value) {
  jspb.Message.setField(this, 3, value);
};


/**
 * optional int64 commentsid = 4;
 * @return {number}
 */
proto.User.prototype.getCommentsid = function() {
  return /** @type {number} */ (jspb.Message.getFieldProto3(this, 4, 0));
};


/** @param {number} value  */
proto.User.prototype.setCommentsid = function(value) {
  jspb.Message.setField(this, 4, value);
};
 ...
 * @constructor
 */
proto.EmptyBlog = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.EmptyBlog, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.EmptyBlog.displayName = 'proto.EmptyBlog';
}
 ...
 * @return {!Object}
 */
proto.EmptyBlog.prototype.toObject = function(opt_includeInstance) {
  return proto.EmptyBlog.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.EmptyBlog} msg The msg instance to transform.
 * @return {!Object}
 */
proto.EmptyBlog.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.EmptyBlog}
 */
proto.EmptyBlog.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.EmptyBlog;
  return proto.EmptyBlog.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.EmptyBlog} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.EmptyBlog}
 */
proto.EmptyBlog.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.EmptyBlog} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.EmptyBlog.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.EmptyBlog.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.EmptyBlog.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
};
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.EmptyBlog} The clone.
 */
proto.EmptyBlog.prototype.cloneMessage = function() {
  return /** @type {!proto.EmptyBlog} */ (jspb.Message.cloneMessage(this));
};
